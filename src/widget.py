...
def mask_account_card(card_tipe_number: str) -> str:
    ''' Функция определяет счет или карточка, возвращает соотвествующую кодировку '''
    ...
    if card_split[0] == 'Счет':
        ...
        return f"{card_name} {get_mask_card_number(card_split[-1])}"


def get_date(iso_date_str: str) -> str:
    ''' Функция принимает на вход строку с датой в формате 2024-03-11T02:26:18.671407 и возвращает строку с датой в формате ("11.03.2024" ).'''
